...
let DataService = class DataService {
    ...
    getAllBooks() {
        ...
        return this.http.get('/api/books', {
            context: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpContext().set(_cache_interceptor__WEBPACK_IMPORTED_MODULE_2__.CACHEABLE, true)
        })
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(error => this.handlehttpError(error)));
    }
    ...
    getBookById(id) {
        ...
        let getHeader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpHeaders({
            'Accept': 'application/json',
            'Authorization': 'my-token'
        });
        return this.http.get(`/api/books/${id}`, { headers: getHeader });
    }
    GetOldBookById(id) {
    ...
    AddBook(newbook) {
        return this.http.post('/api/books', newbook, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpHeaders({
                'content-Type': 'application/json'
            })
        });
    }
    UpdateBook(updatebook) {
        return this.http.put(`/api/books/${updatebook.bookID}`, updatebook, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpHeaders({
                'content-Type': 'application/json'
            })
        });
    }
...
let DashboardComponent = class DashboardComponent {
    ...
    deleteBook(bookID) {
        this.dataService.DeleteBook(bookID).subscribe((data) => {
            let index = this.allBooks.findIndex(book => bookID === book.bookID);
...
let EditBookComponent = class EditBookComponent {
    ...
    ngOnInit() {
        ...
        this.dataService.getBookById(bookID).subscribe((data) => this.selectedBook = data, (err) => console.log(err), () => console.log("operation is completed"));
